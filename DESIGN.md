...
## Networking / Meta
- **Web publish**: Godot HTML5 export (`export_presets.cfg` → committed `web/`) hosted on **Vercel** with COOP/COEP for threaded WASM (`vercel.json` outputDirectory `web`; `tools/export_web.sh`).
